...
// Auth (/api/login, /api/session/*, /api/auth/*). Middlewares — attachSessionUser
// (global) and requireAdmin (per-route) — are imported directly and still used
// by the un-extracted routes below.
